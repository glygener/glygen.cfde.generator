...
public class PtmTypeFile extends TSVFile
{
    public PtmTypeFile(String a_folderPath) throws IOException
    {
        super();
        this.m_header = new String[] { "id", "name", "description", "synonyms" };
        this.openFile(a_folderPath + File.separator + "ptm_type.tsv");
    }
